...
public class AjouterCatServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        cat.setNom(nom);
        service.ajouterCat(cat);
        //Demander au navigateur de faire une reg http get vers la route de listcatservlet
        //redirect to the servlet which iniitialise the attribute listCat
        resp.sendRedirect("lister-categories");
        //req.getRequestDispatcher("lister-categories");
    }
